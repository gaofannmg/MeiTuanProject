...
- (void) refreshThirdCell:(NSDictionary *)dic
{
    ...
    nameSubLabel.font =[UIFont systemFontOfSize:15];
    ...
    numberSubLabel.font =[UIFont systemFontOfSize:15];
    ...
    priceSubLabel.font = [UIFont systemFontOfSize:15];
    ...
    totalSubLabel.font = [UIFont systemFontOfSize:12];
    ...
    groupBuyLabel.font =[UIFont systemFontOfSize:15];
    ...
    groupBuySubLabel.font = [UIFont systemFontOfSize:15];
    ...
    mornBtn.titleLabel.font =[UIFont systemFontOfSize:15];
